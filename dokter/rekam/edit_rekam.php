...
<form action="" method="POST" enctype="multipart/form-data" onsubmit="return false">
    ...
    <div class="form-group">
        ...
        <textarea name="diagnosa" id="diagnosa" rows="4" class="form-control"><?php echo $tampil['diagnosa'] ?></textarea>
    </div>
        ...
        <tbody>
            ...
            <?php while ($tampil_rekam_obat = $ambil_rekam_obat->fetch_assoc()) { ?>
                <tr class="tr" data-id_rekam_obat="<?= $tampil_rekam_obat['id_rekam_obat'] ?>">
                        ...
                        <div class="form-group">
                            <select name="obat" class="form-control">
                                ...
                                <?php while ($obat = $ambil->fetch_assoc()) { ?>
                                    <option <?= ($tampil_rekam_obat['id_obat'] == $obat['id_obat']) ? 'selected' : '' ?> value="<?= $obat['id_obat'] ?>"><?= $obat['nama_obat'] ?> (<?= $obat['jenis_obat'] ?>)
                                    </option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <td>
                        <div class="form-group">
                            <input type="number" name="jumlah" placeholder="jumlah" value="<?= $tampil_rekam_obat['jumlah'] ?>" class="form-control">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <input type="text" name="keterangan" placeholder="keterangan" value="<?= $tampil_rekam_obat['keterangan'] ?>" class="form-control">
                        </div>
                    </td>
                    <td>
